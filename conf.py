...
BLOG_AUTHOR = "Gérald Kerma"  # (translatable)
BLOG_TITLE = "mon Blog"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://blog.kerma.eu/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://doukki.net/"
BLOG_EMAIL = "gandalf@gk2.net"
BLOG_DESCRIPTION = "This is my own blogging site."  # (translatable)
